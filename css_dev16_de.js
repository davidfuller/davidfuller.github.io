...
#scheduling-nav-buttons, #walla-nav-buttons, #location-nav-buttons, #script-nav-buttons, #comparison, #us-script, #script-control, #multiActorButtons, #german-nav-buttons {
...
#for-director-page, #for-actor-page, #for-scheduling-page, #walla-import-page, #location-page, #script-page, #german-page {
  display: none;
}

#for-director-label, #for-actor-label, #for-scheduling-label, #walla-import-label, #location-label, #script-label, #german-label {
  font-size: 22px;
  font-weight: bold;
  margin-left: 15px
}
...
#director-wait, #actor-wait, #scheduling-wait, #formula-wait, #scene-wait, #scene-add-wait, #load-message, #script-wait, #take-wait, #character-wait, #take-message, #resize-wait, #walla-cues-wait, #test-message, #test-count {
  display: none;
  font-size: 15px;
  margin-left: 5px;
}
...
#germanButtons, #german-nav-buttons {
  border-color: #700000;
}
