...
<div id="firstButtons">
  ...
  <button id="btnTest" onclick="jade_modules.operations.addTakeDetails('UK', true, false, false, false)">Test</button><br/>
  <button id="btnTest" onclick="jade_modules.operations.removeTake('UK')">Test Remove</button>
</div>
<div id="showTakes">
