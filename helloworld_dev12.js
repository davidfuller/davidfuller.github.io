async function auto_exec(){
  ...
  await Jade.load_js("https://davidfuller.github.io/operations_dev12.js", "operations");
  console.log('After operations');
  await Jade.load_js("https://davidfuller.github.io/scheduling_dev12.js", "scheduling");
  console.log('After scheduling');
  await Jade.load_js("https://davidfuller.github.io/walla_import_dev12.js", "wallaimport");
  console.log('After wallaimport');
  await Jade.load_js("https://davidfuller.github.io/comparison_dev12.js", "comparison");
  ...
  await Jade.load_js("https://davidfuller.github.io/css_dev12.js", "css");
