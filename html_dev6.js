...
<div id="for-director-page">
  ...
  <button id="btnWallaImport" class="director-nav" onclick="jade_modules.operations.showWallaImportPage()">Walla Import</button><br/>
...
<div id="for-actor-page">
  ...
  <button id="btnForDirectorPage" class="actor-nav" onclick="jade_modules.operations.showForDirector()">For Director</button>
  ...
  <button id="btnWallaImport" class="actor-nav" onclick="jade_modules.operations.showWallaImportPage()">Walla Import</button><br/>
  <div id="forActorsButtons">
    <button id='btnGetActorInfo' class='actor-button' onclick="jade_modules.scheduling.getActorInfo()">Calculate for<br/>actor information<br/>for selected character</button>
...
<div id="for-scheduling-page">
  ...
  <button id="btnForDirectorPage" class="scheduling-nav" onclick="jade_modules.operations.showForDirector()">For Director</button>
  <button id="btnForActorPage" class="scheduling-nav" onclick="jade_modules.operations.showForActorsPage()">For Actors</button>
  <button id="btnWallaImport" class="scheduling-nav" onclick="jade_modules.operations.showWallaImportPage()">Walla Import</button><br/>
...
<div id="walla-import-page">
  ...
  <button id="btnForDirectorPage" class="walla-nav" onclick="jade_modules.operations.showForDirector()">For Director</button>
...
<div id="location-page">
  ...
  <button id="btnForDirectorPage" class="location-nav" onclick="jade_modules.operations.showForDirector()">For Director</button>
