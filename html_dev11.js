...
<div id="main-page">
  ...
  <div id="admin">
    ...
    <button id='btnSceneCheck' onclick="jade_modules.operations.getLineNumberRanges()">Scene Number Check</button>
...
<div id="walla-import-page">
  ...
  <div id="wallaImportButtons">
    ...
    <button id="btnWallaScripting" class="walla-button" onclick="jade_modules.wallaimport.doWallaScripting()">Do Walla Scripting</button>
