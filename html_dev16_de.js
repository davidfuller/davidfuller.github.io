...
async function mainHTML(){
  const html = `
<h1>MuVi2 German Script Controller</h1>
...
<div id="main-page">
  ...
  <div id="firstButtons">
    ...
    <div id='lock-buttons'>
      ...
      <button id='btnProtectWorkbook' onclick="jade_modules.operations.protectWorkbook()">Protect workbook</button>
      <button id='btnUnlProtectWorkbook' onclick="jade_modules.operations.unprotectWorkbook()">Unprotect workbook</button><br/>
  ...
  <div id="filterButtons" >
    ...
    <div id='filter-buttons'>
      ...
      <button id='btnTemporarySheetView' onclick="jade_modules.operations.temporarySheetView()">Temporary Sheet View</button>
  ...
  <div id="showColumns">
    ...
    <div id="column-buttons">
      ...
      <button id='btnShowUK' onclick="jade_modules.operations.showHideColumns('German Script')">German Script Only</button>
      <button id='btnShowUS' onclick="jade_modules.operations.showHideColumns('German UK Script')">German UK Script</button>
  ...
  <div id="dateStudioEngineer">
    ...
    <div id="add-remove-buttons">
      ...
      <div>
        <button id="btnApplyTakeGerman" class="take-button" onclick="jade_modules.operations.applyTakeDetails('German')">Apply Take German</button>
        ...
        <button id="btnClearTakeUk" class="take-button" onclick="jade_modules.operations.clearTakeDetails('German')">Clear Take German</button>
...
<div id="for-actor-page">
  ...
  <div id="forActorsButtons">
    ...
    <a id='show-hide-for-actor' onclick="jade_modules.testing.showAdminForActor()">Show/hide admin</a>
    <div id="admin-actor">
  ...
  <div id="multiActorButtons">
    ...
    <button id="btnMoveUp" class="actor-multi" onclick="jade_modules.actormultiple.moveUp()">Move Up</button>
    <button id="btnMoveDown" class="actor-multi" onclick="jade_modules.actormultiple.moveDown()">Move Down</button><br/>
...
<div id="for-scheduling-page">
  ...
  <div id="forSchedulingButtons">
    ...
    <button id="btnSchedulingGoToLine" class="scheduling-button" onclick="jade_modules.scheduling.schedulingGoToLine()">Goto first line of<br/>the selected scene</button><br/>
    <a id='show-hide-for-scheduling' onclick="jade_modules.testing.showAdminForScheduling()">Show/hide admin</a>
    <div id="admin-scheduling">
...
<div id="german-page">
  ...
  <div id="germanButtons">
    ...
    <button id="btnFormatGermanDirections" class="german-button" onclick="jade_modules.german.germanFormats('directions')">Directions formatting</button>
    <button id="btnFormatGermanCharacter" class="german-button" onclick="jade_modules.german.germanFormats('character')">Character formatting</button>
  ...
  console.log("I'm here data loaded. Dev 16");
}
