...
<div id="main-page">
  ...
  <div id="jump">
    ...
    <div id="jump-buttons">
      ...
      <button id='btnFirst' onclick="jade_modules.operations.firstChapter()">First chapter</button>
      <button id='btnPrev' onclick="jade_modules.operations.findChapter(-1)">Prev chapter</button>
      <button id='btnNext' onclick="jade_modules.operations.findChapter(1)">Next chapter</button>
      <button id='btnLast' onclick="jade_modules.operations.lastChapter()">Last chapter</button><br/>
      <div class="row">
