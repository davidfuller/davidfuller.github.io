...
<div id="main-page">
  ...
  <div id="admin">
    <label class="section-label" onclick="jade_modules.operations.showAdmin()">Admin</label><a id='show-hide-admin' onclick="jade_modules.operations.showAdmin()">Show/hide admin</a>
