async function auto_exec(){
  ...
  await Jade.load_js("https://davidfuller.github.io/operations_dev4.js", "operations");
  console.log('After operations');
  await Jade.load_js("https://davidfuller.github.io/scheduling_dev4.js", "scheduling");
  console.log('After scheduling');
  await Jade.load_js("https://davidfuller.github.io/walla_import_dev4.js", "wallaimport");
  console.log('After wallaimport');
  await Jade.load_js("https://davidfuller.github.io/html_dev4.js", "html");
  console.log('After html');
  await Jade.load_js("https://davidfuller.github.io/css_dev4.js", "css");
