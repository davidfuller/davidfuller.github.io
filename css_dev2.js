...
*/
#studio, #engineer, #studio-select, #engineer-select, #chapter-scene-select, #markup {
  width: 150px;
  background-color: #d8dfe5;
  color: #46656F;
  font-family: 'Aptos Narrow', 'Arial Narrow'Arial, Helvetica, sans-serif;
...
#director-wait, #actor-wait, #scheduling-wait, #formula-wait, #scene-wait, #scene-add-wait {
  display: none;
  font-size: 15px;
  margin-left: 15px;
}                    `;
