async function auto_exec(){
  ...
  await Jade.load_js("https://davidfuller.github.io/operations_dev13.js", "operations");
  console.log('After operations');
  await Jade.load_js("https://davidfuller.github.io/scheduling_dev13.js", "scheduling");
  console.log('After scheduling');
  await Jade.load_js("https://davidfuller.github.io/walla_import_dev13.js", "wallaimport");
  console.log('After wallaimport');
  await Jade.load_js("https://davidfuller.github.io/comparison_dev13.js", "comparison");
  ...
  await Jade.load_js("https://davidfuller.github.io/usScript_dev13.js", "usscript");
  console.log('After usScript');
  await Jade.load_js("https://davidfuller.github.io/actorMultiple_dev13.js", "actormultiple");
  console.log('After actormultiple');
  await Jade.load_js("https://davidfuller.github.io/html_dev13.js", "html");
  console.log('After html');
  await Jade.load_js("https://davidfuller.github.io/css_dev13.js", "css");
