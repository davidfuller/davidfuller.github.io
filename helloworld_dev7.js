async function auto_exec(){
  ...
  await Jade.load_js("https://davidfuller.github.io/operations_dev7.js", "operations");
  console.log('After operations');
  await Jade.load_js("https://davidfuller.github.io/scheduling_dev7.js", "scheduling");
  console.log('After scheduling');
  await Jade.load_js("https://davidfuller.github.io/walla_import_dev7.js", "wallaimport");
  console.log('After wallaimport');
  await Jade.load_js("https://davidfuller.github.io/html_dev7.js", "html");
  console.log('After html');
  await Jade.load_js("https://davidfuller.github.io/css_dev7.js", "css");
