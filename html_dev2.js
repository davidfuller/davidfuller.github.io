...
<div id="main-page">
  ...
  <div id="firstButtons">
    ...
    <button id='btnLock' onclick="jade_modules.operations.lockScriptSheet()">Lock script sheet</button>
    <button id='btnUnlock' onclick="jade_modules.operations.unlockScriptSheet()">Unlock script sheet</button><br/>
  </div>
