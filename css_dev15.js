...
#director-wait, #actor-wait, #scheduling-wait, #formula-wait, #scene-wait, #scene-add-wait, #load-message, #script-wait, #take-wait, #character-wait, #take-message, #resize-wait, #walla-cues-wait, #test-message {
  display: none;
  font-size: 15px;
  margin-left: 5px;
}
