...
*/
#studio, #engineer, #studio-select, #engineer-select, #chapter-scene-select, #markup, #walla-scene, #chapter-compare-select {
  width: 150px;
  background-color: #d8dfe5;
  color: #46656F;
  font-family: 'Aptos Narrow', 'Arial Narrow'Arial, Helvetica, sans-serif;
...
#show-hide, #show-hide-lock, #show-hide-filter, #show-hide-jump, #show-hide-columns, #show-hide-takes {
  margin-left: 5px;
  font-size: 10px;
  padding-left: 5px;
  cursor: pointer;
...
#lock-buttons, #filter-buttons, #jump-buttons, #column-buttons, #takes-buttons {
  display: none; 
}
